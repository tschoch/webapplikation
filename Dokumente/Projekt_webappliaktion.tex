...
Für das verwendete Javascript und PHP wurde kein Framework verwendet.
...
Für einen Facebook Login muss ein Facebook Developer Account erstellt werden. Danach kann die App erstellt werden und es wird eine App-ID und ein App-Secret erstellt.
...
Browsers mitgegeben: https://maps.googleapis.com/maps/api/geocode/json?address=Pulverm
%C3%BChlestrasse+57,+7000+Chur 
